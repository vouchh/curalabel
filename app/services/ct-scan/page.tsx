...
export const metadata = {
  title: "CT-Scan Annotation – CuraLabel",
};
...
export default function Page(){return (
  <div>
    <section className="section">
      ...
      <img 
          src="/images/ctscan.jpeg" 
          alt="CT-Scan Annotation" 
          className="w-[800px] rounded-2xl border border-slate-800" 
        />  
        <div>
          <h1 className="text-4xl font-extrabold">CT-Scan Annotation</h1>
          <p className="mt-3 text-slate-300">High-fidelity 2D/3D CT masks for organs and lesions with HU-aware workflows.</p>
    ...
    <section className="section bg-slate-900/40">
      <div className="container">
        ...
        <ul className="mt-4 grid md:grid-cols-2 gap-3 text-slate-300">
          <li>• Liver, lung, pancreas segmentation</li>
          <li>• Pulmonary nodules & LIDC schema</li>
          <li>• Bone structures & fractures</li>
          <li>• Contrast timing considerations</li>
          <li>• Dose & slice thickness handling</li>
        </ul>
      </div>
    </section>
    ...
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/ctscan2.jpg" alt="Deliverables" className="rounded-2xl border border-slate-800" />
        <div>
