...
export const metadata = {
  title: "Raw data (without annotation) – CuraLabel",
};
  ...
  <div>
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/raw.jpg" alt="Raw data (without annotation)" className="rounded-2xl border border-slate-800" />
        <div>
          <h1 className="text-4xl font-extrabold">Raw data (without annotation)</h1>
          <p className="mt-3 text-slate-300">Secure ingest, checksum validation, deduplication, and metadata curation without labels.</p>
    ...
    <section className="section bg-slate-900/40">
      <div className="container">
        ...
        <ul className="mt-4 grid md:grid-cols-2 gap-3 text-slate-300">
          <li>• DICOM validation & hashing</li>
          <li>• De-identification optional</li>
          <li>• Folder normalization</li>
          <li>• Manifest & previews</li>
    ...
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/raw2.jpg" alt="Deliverables" className="rounded-2xl border border-slate-800" />
        <div>
