...
export const metadata = {
  title: "MRI Annotation – CuraLabel",
};
  ...
  <div>
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/mri.jpeg" alt="MRI Annotation" className="rounded-2xl border border-slate-800" />
        <div>
          <h1 className="text-4xl font-extrabold">MRI Annotation</h1>
          <p className="mt-3 text-slate-300">Multi-sequence MRI segmentation and lesion delineation with neuroradiology oversight.</p>
    ...
    <section className="section bg-slate-900/40">
      <div className="container">
        ...
        <ul className="mt-4 grid md:grid-cols-2 gap-3 text-slate-300">
          <li>• T1/T2/FLAIR/DWI/ADC sequences</li>
          <li>• 3D tumor masks & volumetrics</li>
          <li>• White-matter hyperintensities</li>
          <li>• MS lesions & edema</li>
          <li>• Knee & shoulder MSK</li>
        </ul>
      </div>
    </section>
    ...
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/mri2.jpg" alt="Deliverables" className="rounded-2xl border border-slate-800" />
        <div>
