...
export const metadata = {
  title: "De-identification – CuraLabel",
};
  ...
  <div>
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/de-id.png" alt="De-identification" className="w-[300px] rounded-2xl border border-slate-800" />
        <div>
          <h1 className="text-4xl font-extrabold">De-identification</h1>
          <p className="mt-3 text-slate-300">PHI redaction for DICOM and clinical reports with audit logs and attestations.</p>
    ...
    <section className="section bg-slate-900/40">
      <div className="container">
        ...
        <ul className="mt-4 grid md:grid-cols-2 gap-3 text-slate-300">
          <li>• DICOM tag scrubbing</li>
          <li>• OCR + NLP for reports</li>
          <li>• Hashing & tokenization</li>
          <li>• Access logs</li>
