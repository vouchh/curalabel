  ...
  <div>
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/ecg.webp" alt="ECG/EKG" className="rounded-2xl border border-slate-800" />
        <div>
          <h1 className="text-4xl font-extrabold">ECG/EKG</h1>
          <p className="mt-3 text-slate-300">Beat detection, rhythm classification, and interval labeling for 12-lead and Holter data.</p>
    ...
    <section className="section bg-slate-900/40">
      <div className="container">
        ...
        <ul className="mt-4 grid md:grid-cols-2 gap-3 text-slate-300">
          ...
          <li>• PR/QRS/QT intervals</li>
          <li>• Arrhythmia tags</li>
          <li>• Noise curation</li>
          <li>• Report alignment</li>
        </ul>
      </div>
    </section>
    ...
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/ecg2.png" alt="Deliverables" className="rounded-2xl border border-slate-800" />
        <div>
