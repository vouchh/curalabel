  ...
  <div>
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/qa.webp" alt="QA & Audit" className="rounded-2xl border border-slate-800" />
        <div>
          <h1 className="text-4xl font-extrabold">QA & Audit</h1>
          <p className="mt-3 text-slate-300">Independent auditing and consensus labeling to reduce noise and improve model outcomes.</p>
    ...
    <section className="section bg-slate-900/40">
      <div className="container">
        ...
        <ul className="mt-4 grid md:grid-cols-2 gap-3 text-slate-300">
          <li>• Secondary & tertiary reviews</li>
          <li>• IRR / Cohen’s kappa tracking</li>
          <li>• Guideline drift detection</li>
          <li>• Spot-checks & sampling</li>
    ...
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        <img src="/images/qa2.jpg" alt="Deliverables" className="rounded-2xl border border-slate-800" />
        <div>
          <h3 className="text-2xl font-bold">Deliverables</h3>
          <ul className="mt-3 grid gap-2 text-slate-300">
            <li>• Raw files of actual patient data with de-identification</li>
            <li>• Doctor's notes when available</li>
            <li>• Ready to Annotate</li>
          </ul>
        </div>
      </div>
    </section>
